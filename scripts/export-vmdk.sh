...
wget http://download.virtualbox.org/virtualbox/6.0.2/VirtualBox-6.0-6.0.2_128162_el6-1.x86_64.rpm
echo "56cb3f23d75efebd351b220c04affd57 VirtualBox-6.0-6.0.2_128162_el6-1.x86_64.rpm" | md5sum -c /dev/stdin
rpm -i --nodeps VirtualBox-6.0-6.0.2_128162_el6-1.x86_64.rpm
